...
const StrategyAnalysis: React.FC<StrategyAnalysisProps> = ({ challenge, setActivePage }) => {
  ...
  const stats = useMemo(() => {
      ...
      return { totalSessions, totalTimeSeconds, averageTimeSeconds, mostPracticedActivity, activityLog, topActivities, longestSession, shortestSession };
  }, [challenge]);
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500">Progress Analysis</p>
                </div>
            </div>
          </div>
          ...
          <div ref={reportRef} className="p-2 bg-white rounded-lg">
            <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <StatCard icon="fas fa-clock" label="Total Time" value={formatSeconds(stats.totalTimeSeconds)} />
                    
                    <StatCard icon="fas fa-stopwatch" label="Avg Session" value={formatSeconds(stats.averageTimeSeconds)} />
                    <StatCard icon="fas fa-star" label="Most Practiced" value={stats.mostPracticedActivity ? stats.mostPracticedActivity.title : 'N/A'} />

                    <StatCard icon="fas fa-arrow-up" label="Longest Session" value={formatSeconds(stats.longestSession)} />
                    <StatCard icon="fas fa-arrow-down" label="Shortest Session" value={formatSeconds(stats.shortestSession)} />
                </div>
            </div>
